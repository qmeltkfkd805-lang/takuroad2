...
if (process.env.ALLOW_LEGACY_PATH_IMPORT !== 'I-UNDERSTAND-THIS-RECREATES-DUPLICATES') {
  ...
  console.error('  script : registerConan30MuseumGoods.mjs')
...
const row = { name: '한국 전시 오리지널 MD 목록', filename: 'original-md-list-1.jpg' }
...
const backup = `scripts/event-goods-backups/before-conan30-museum-${stamp}.json`
